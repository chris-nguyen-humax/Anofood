...
namespace Anofoods.Infrastructure.Base
{
    ...
    {
        private AnoFoodEntities _context;

        public IDbSet<T> Dbset;
        private readonly AnoFoodEntities _dbContext;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:System.Object"/> class.
        /// </summary>
        public BaseRepository(AnoFoodEntities context)
        {
            _dbContext = context;
        ...
        //{
        //    page = (page <= 0) ? 1 : page;
        //    pageSize = (pageSize <= 0) ? ConstantHelper.DEFAULT_PAGE_SIZE : pageSize;
